...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { area: @farm.area, farm_url: @farm.farm_url, farmname: @farm.farmname, image_url: @farm.image_url, message: @farm.message }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { area: @farm.area, farm_url: @farm.farm_url, farmname: @farm.farmname, image_url: @farm.image_url, message: @farm.message }
    assert_redirected_to farm_path(assigns(:farm))
  end
