...
class CropsControllerTest < ActionController::TestCase
  ...
  test "should create crop" do
    assert_difference('Crop.count') do
      post :create, crop: { discription: @crop.discription, farms_count: @crop.farms_count, name: @crop.name }
    end
  ...
  test "should update crop" do
    patch :update, id: @crop, crop: { discription: @crop.discription, farms_count: @crop.farms_count, name: @crop.name }
    assert_redirected_to crop_path(assigns(:crop))
  end
